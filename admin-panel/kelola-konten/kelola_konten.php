...
<div id="content">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <h3><i class="mr-2"></i></i>KONTEN</h3><hr>
    <a href="tambah_gambar.php" class="btn btn-primary mb-3"><i class="fas fa-plus-square mr-2"></i>GAMBAR</a>
          ...
          <?php 
            ...
            while($data = mysqli_fetch_array($sql)) { ?>
              ...
              <tr>
                ...
                <td>
                  <img src="<?php echo "../DataUpload/".$data['image']; ?>" width="100px" alt="Image">
                </td>

                <td>
                  <a href="edit.php?id=<?php echo $data['id']; ?>"><i class="fas fa-edit bg-success p-2 text-white rounded" data-toogle="tooltip" title="Edit"></i></a>
