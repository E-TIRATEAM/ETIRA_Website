...
<div id="content">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <h3><i class="mr-2"></i></i>AKUN</h3><hr>
    <a href="tambah_akun.php" class="btn btn-primary mb-3"><i class="fas fa-plus-square mr-2"></i> DATA AKUN</a>
    <table class="table table-striped table-bordered">
      ...
      <tbody>
          ...
          <?php 
            ...
            $sql = mysqli_query($conn, "SELECT * FROM data_users");
